...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            images: [`/api/og?title=${encodeURIComponent(post.title)}`], // Theoretical endpoint
        },
        twitter: {
...
export default function BlogPostPage({ params }: Props) {
    ...
    // Get 3 random related posts (excluding current) - simple randomization for now
            ...
            <div className="max-w-4xl mx-auto">
                <header className="mb-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-6 text-muted-foreground max-w-2xl mx-auto">
                        <div className="flex items-center gap-2">
                            <img src={defaultAuthor.avatar} alt={defaultAuthor.name} className="w-10 h-10 rounded-full bg-slate-200" />
                ...
                <div className="bg-muted/30 rounded-xl p-8 flex flex-col sm:flex-row gap-8 items-center sm:items-start mb-16 border border-border/50">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <a href={defaultAuthor.url} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-muted-foreground hover:text-foreground underline underline-offset-4">
                            Follow on Twitter
                        </a>
                    </div>
                </div>
                ...
                <div className="bg-primary/5 rounded-2xl p-8 sm:p-12 text-center mb-16 border border-primary/10">
                    ...
                    <Link href="/tools" className="inline-block bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors">
                        Explore AI Tools
                    </Link>
                </div>
